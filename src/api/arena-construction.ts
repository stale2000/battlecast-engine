    ...
    return {
      ...
      heroOverrides: {
        ...
        ...(species && background ? {
          ...
          additionalResources: { ...(species === 'Orc' ? { 'orc-adrenaline-rush': 3 } : {}), ...(species === 'Goliath' ? { 'goliath-large-form': 1, 'goliath-giant-ancestry': 3 } : {}), ...(species === 'Elf' && elfLineage === 'Drow' ? { 'drow-faerie-fire': 1 } : {}), ...(species === 'Elf' && elfLineage === 'High Elf' ? { 'high-elf-misty-step': 1 } : {}), ...(species === 'Tiefling' && tieflingLegacy === 'Abyssal' ? { 'abyssal-ray-of-sickness': 1, 'abyssal-hold-person': 1 } : {}), ...(species === 'Tiefling' && tieflingLegacy === 'Chthonic' ? { 'chthonic-false-life': 1 } : {}), ...(species === 'Tiefling' && tieflingLegacy === 'Infernal' ? { 'infernal-hellish-rebuke': 1 } : {}), ...(origin?.resources ?? {}), ...(humanOrigin?.resources ?? {}) },
          additionalActions: [...(species === 'Dragonborn' ? [dragonbornBreath(character.dragonAncestry as DragonAncestry, abilities)] : []), ...(species === 'Elf' && elfLineage === 'Drow' ? [drowFaerieFire(speciesCastingAbility!, abilities)] : []), ...(species === 'Tiefling' ? [tieflingCantrip(tieflingLegacy!, speciesCastingAbility!, abilities)] : []), ...(species === 'Tiefling' && tieflingLegacy === 'Abyssal' ? [abyssalRayOfSickness(speciesCastingAbility!, abilities), { ...holdPerson(speciesCastingAbility!, Math.floor((abilities[speciesCastingAbility!] - 10) / 2), 3), resourceCost: { key: 'abyssal-hold-person', amount: 1 } }] : []), ...(species === 'Tiefling' && tieflingLegacy === 'Chthonic' ? [chthonicFalseLife(speciesCastingAbility!)] : []), ...(origin?.actions ?? []), ...(humanOrigin?.actions ?? [])],
