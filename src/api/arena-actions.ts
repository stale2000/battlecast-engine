...
export type ArenaAction =
  ...
  | { id: string; type: 'spell'; actionName: string; actionIndex: number; targetId: string; targetIds?: string[]; center?: { x: number; y: number }; areaShape?: string; effectKey?: string; damageResistance?: string; damageType?: string; curseChoice?: 'attack_disadvantage' | 'damage_rider' }
