...
import {
  ...
  scorchingRay, summonBeast, dragonsBreath, summonFey, summonUndead, animateDead, findSteed, conjureAnimals, web, spikeGrowth, flamingSphere, cloudOfDaggers, shatter, moonbeam, holdPerson, spiritualWeapon,
  ...
  acidArrow, acidSplash, armsOfHadar, barkskin, bestowCurse, bladeWard, blur, colorSpray, darkness, daylight, divineFavor, enlargeReduce, expeditiousRetreat, faerieFire, falseLife, fear, flameBlade, fly, fogCloud, grease, gustOfWind, heatMetal, iceKnife, lesserRestoration, mindSpike, mistyStep, spareTheDying,
...
import { arenaCombatCantrip } from './arena-combat-cantrips.js';
...
function buildClassSpells(
  ...
  switch (className) {
    ...
    case 'Cleric':
      ...
      repertoire.push(aid(spellAbility, mod, pb), holdPerson(spellAbility, mod, pb), spiritualWeapon(spellAbility, mod, pb), silence(spellAbility, mod, pb));
    ...
    case 'Bard':
      ...
      repertoire.push(holdPerson(spellAbility, mod, pb), shatter(spellAbility, mod, pb), silence(spellAbility, mod, pb));
      repertoire.push(hypnoticPattern(spellAbility, mod, pb));
    ...
    case 'Ranger':
      ...
      repertoire.push(hailOfThorns(spellAbility, mod, pb), silence(spellAbility, mod, pb));
      repertoire.push(lightningArrow(spellAbility, mod, pb));
      break;
  }
...
function buildOptionalSpells(
  ...
  switch (className) {
    case 'Wizard':
      ...
      pool.push(blindnessDeafness(spellAbility, mod, pb), blur(spellAbility, mod, pb), cloudOfDaggers(spellAbility, mod, pb), darkness(spellAbility, mod, pb), enlargeReduce(spellAbility, mod, pb), flamingSphere(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), magicWeapon(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb), rayOfEnfeeblement(spellAbility, mod, pb), seeInvisibility(spellAbility, mod, pb));
      pool.push(holdPerson(spellAbility, mod, pb), shatter(spellAbility, mod, pb));
      pool.push(acidArrow(spellAbility, mod, pb), dragonsBreath(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb), animateDead(spellAbility, mod, pb), gustOfWind(spellAbility, mod, pb), protectionFromEnergy(spellAbility, mod, pb), wardingWind(spellAbility, mod, pb));
    ...
    case 'Sorcerer':
      ...
      pool.push(chromaticOrb(spellAbility, mod, pb), colorSpray(spellAbility, mod, pb), iceKnife(spellAbility, mod, pb), charmPerson(spellAbility, mod, pb), sleep(spellAbility, mod, pb), witchBolt(spellAbility, mod, pb));
      pool.push(shield(spellAbility, mod, pb), fogCloud(spellAbility, mod, pb));
      ...
      pool.push(blindnessDeafness(spellAbility, mod, pb), blur(spellAbility, mod, pb), darkness(spellAbility, mod, pb), enlargeReduce(spellAbility, mod, pb), flamingSphere(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), magicWeapon(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb), seeInvisibility(spellAbility, mod, pb));
    ...
    case 'Warlock':
      ...
      pool.push(bestowCurse(spellAbility, mod, pb), fear(spellAbility, mod, pb), fly(spellAbility, mod, pb), hungerOfHadar(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mistyStep(spellAbility, mod, pb), vampiricTouch(spellAbility, mod, pb), bane(spellAbility, mod, pb));
      pool.push(mirrorImage(spellAbility, mod, pb));
      pool.push(counterspell(spellAbility, mod, pb), dispelMagic(spellAbility, mod, pb));
      break;
    case 'Cleric':
      pool.push(bane(spellAbility, mod, pb), inflictWounds(spellAbility, mod, pb), resistance(spellAbility, mod, pb), spareTheDying(spellAbility, mod, pb), tollTheDead(spellAbility, mod, pb), command(spellAbility, mod, pb), protectionFromEvilAndGood(spellAbility, mod, pb), sanctuary(spellAbility, mod, pb), wardingBond());
      ...
      pool.push(massHealingWord(spellAbility, mod, pb));
      pool.push(revivify(spellAbility, mod, pb));
      break;
    case 'Druid':
      pool.push(poisonSpray(spellAbility, mod, pb), produceFlame(spellAbility, mod, pb), resistance(spellAbility, mod, pb), spareTheDying(spellAbility, mod, pb), shillelagh(spellAbility, mod, pb), starryWisp(spellAbility, mod, pb), thunderclap(spellAbility, mod, pb), thornWhip(spellAbility, mod, pb), iceKnife(spellAbility, mod, pb));
      ...
      break;
    case 'Bard':
      pool.push(bladeWard(spellAbility, mod, pb), starryWisp(spellAbility, mod, pb), thunderclap(spellAbility, mod, pb), trueStrike(spellAbility, mod, pb));
      pool.push(thunderwave(spellAbility, mod, pb));
      pool.push(colorSpray(spellAbility, mod, pb), sleep(spellAbility, mod, pb), charmPerson(spellAbility, mod, pb));
      ...
      pool.push(command(spellAbility, mod, pb), silence(spellAbility, mod, pb));
      pool.push(blindnessDeafness(spellAbility, mod, pb), cloudOfDaggers(spellAbility, mod, pb), heatMetal(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb), seeInvisibility(spellAbility, mod, pb), stinkingCloud(spellAbility, mod, pb));
      pool.push(enlargeReduce(spellAbility, mod, pb), lesserRestoration(spellAbility, mod, pb));
      pool.push(dispelMagic(spellAbility, mod, pb), haste(spellAbility, mod, pb), plantGrowth(spellAbility, mod, pb), slow(spellAbility, mod, pb));
      pool.push(massHealingWord(spellAbility, mod, pb));
      pool.push(bestowCurse(spellAbility, mod, pb), fear(spellAbility, mod, pb), fly(spellAbility, mod, pb));
      break;
    case 'Paladin':
...
export function getAvailableSpells(
  ...
  switch (className) {
    case 'Wizard':
      repertoire.push(magicMissile(), burningHands(spellAbility, mod, pb), thunderwave(spellAbility, mod, pb), sleep(spellAbility, mod, pb));
      repertoire.push(scorchingRay(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb), web(spellAbility, mod, pb));
      repertoire.push(fireball(spellAbility, mod, pb), lightningBolt(spellAbility, mod, pb));
      repertoire.push(iceStorm(spellAbility, mod, pb), banishment(spellAbility, mod, pb), stoneskin(spellAbility, mod, pb), fireShield(spellAbility, mod, pb));
      repertoire.push(coneOfCold(spellAbility, mod, pb), holdMonster(spellAbility, mod, pb), synapticStatic(spellAbility, mod, pb));
      repertoire.push(chainLightning(spellAbility, mod, pb), circleOfDeath(spellAbility, mod, pb), disintegrate(spellAbility, mod, pb));
    ...
    case 'Warlock':
      ...
      if (level >= 3) repertoire.push(burningHands(spellAbility, mod, pb), command(spellAbility, mod, pb), scorchingRay(spellAbility, mod, pb));
      repertoire.push(holdPerson(spellAbility, mod, pb));
      repertoire.push(hypnoticPattern(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb));
      if (level >= 5) repertoire.push(fireball(spellAbility, mod, pb));
      if (level >= 3) repertoire.push(hellishRebuke(spellAbility, mod, pb));
      repertoire.push(banishment(spellAbility, mod, pb), blight(spellAbility, mod, pb));
      if (level >= 7) repertoire.push(fireShield(spellAbility, mod, pb), wallOfFire(spellAbility, mod, pb));
  ...
  switch (className) {
    case 'Wizard':
      ...
      optional.push(blindnessDeafness(spellAbility, mod, pb), blur(spellAbility, mod, pb), cloudOfDaggers(spellAbility, mod, pb), darkness(spellAbility, mod, pb), enlargeReduce(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), magicWeapon(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb), rayOfEnfeeblement(spellAbility, mod, pb));
      optional.push(flamingSphere(spellAbility, mod, pb), holdPerson(spellAbility, mod, pb), shatter(spellAbility, mod, pb), seeInvisibility(spellAbility, mod, pb));
      optional.push(acidArrow(spellAbility, mod, pb), dragonsBreath(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb), animateDead(spellAbility, mod, pb), gustOfWind(spellAbility, mod, pb), protectionFromEnergy(spellAbility, mod, pb), wardingWind(spellAbility, mod, pb));
    ...
    case 'Sorcerer':
      optional.push(acidSplash(spellAbility, mod, pb), bladeWard(spellAbility, mod, pb), poisonSpray(spellAbility, mod, pb), sorcerousBurst(spellAbility, mod, pb), thunderclap(spellAbility, mod, pb), trueStrike(spellAbility, mod, pb), arenaCombatCantrip('Ray of Frost', spellAbility, mod, pb), arenaCombatCantrip('Chill Touch', spellAbility, mod, pb), arenaCombatCantrip('Shocking Grasp', spellAbility, mod, pb));
      optional.push(chromaticOrb(spellAbility, mod, pb), colorSpray(spellAbility, mod, pb), iceKnife(spellAbility, mod, pb), charmPerson(spellAbility, mod, pb), sleep(spellAbility, mod, pb), witchBolt(spellAbility, mod, pb));
      optional.push(shield(spellAbility, mod, pb), fogCloud(spellAbility, mod, pb));
      ...
      optional.push(blindnessDeafness(spellAbility, mod, pb), blur(spellAbility, mod, pb), darkness(spellAbility, mod, pb), enlargeReduce(spellAbility, mod, pb), flameBlade(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), magicWeapon(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb));
    ...
    case 'Warlock':
      ...
      optional.push(bestowCurse(spellAbility, mod, pb), fear(spellAbility, mod, pb), fly(spellAbility, mod, pb), hungerOfHadar(spellAbility, mod, pb), summonFey(spellAbility, mod, pb), summonUndead(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), mindSpike(spellAbility, mod, pb), mistyStep(spellAbility, mod, pb), vampiricTouch(spellAbility, mod, pb), bane(spellAbility, mod, pb));
      ...
      break;
    case 'Cleric':
      optional.push(bane(spellAbility, mod, pb), inflictWounds(spellAbility, mod, pb), resistance(spellAbility, mod, pb), spareTheDying(spellAbility, mod, pb), tollTheDead(spellAbility, mod, pb), command(spellAbility, mod, pb), protectionFromEvilAndGood(spellAbility, mod, pb), sanctuary(spellAbility, mod, pb), wardingBond());
      ...
      break;
    case 'Druid':
      optional.push(poisonSpray(spellAbility, mod, pb), produceFlame(spellAbility, mod, pb), resistance(spellAbility, mod, pb), spareTheDying(spellAbility, mod, pb), shillelagh(spellAbility, mod, pb), starryWisp(spellAbility, mod, pb), thunderclap(spellAbility, mod, pb), thornWhip(spellAbility, mod, pb), iceKnife(spellAbility, mod, pb));
      ...
      break;
    case 'Bard':
      optional.push(bladeWard(spellAbility, mod, pb), starryWisp(spellAbility, mod, pb), thunderclap(spellAbility, mod, pb), trueStrike(spellAbility, mod, pb));
      optional.push(thunderwave(spellAbility, mod, pb));
      optional.push(colorSpray(spellAbility, mod, pb), sleep(spellAbility, mod, pb), charmPerson(spellAbility, mod, pb));
      ...
      optional.push(command(spellAbility, mod, pb), silence(spellAbility, mod, pb));
      optional.push(stinkingCloud(spellAbility, mod, pb));
      optional.push(blindnessDeafness(spellAbility, mod, pb), cloudOfDaggers(spellAbility, mod, pb), heatMetal(spellAbility, mod, pb), invisibility(spellAbility, mod, pb), mirrorImage(spellAbility, mod, pb), seeInvisibility(spellAbility, mod, pb));
      optional.push(enlargeReduce(spellAbility, mod, pb), lesserRestoration(spellAbility, mod, pb));
      optional.push(dispelMagic(spellAbility, mod, pb), haste(spellAbility, mod, pb), plantGrowth(spellAbility, mod, pb), slow(spellAbility, mod, pb));
      optional.push(massHealingWord(spellAbility, mod, pb));
      optional.push(bestowCurse(spellAbility, mod, pb), fear(spellAbility, mod, pb), fly(spellAbility, mod, pb));
      break;
    case 'Paladin':
...
export function buildCustomHero(
  ...
  const selectedCantrips = overrides.cantrips ? new Set(overrides.cantrips) : undefined;
  const includeCantrip = Boolean(spec.cantrip) && !selectedCantrips && (
    !selectedSpells || !overrides.spellSelectionIncludesCantrips || selectedSpells.has(spec.cantrip!.name)
  );
  ...
  if (selectedCantrips) {
    const cantripPool = [
      ...(spec.cantrip ? [makeCantripAction(spec.cantrip, level, abilities, pb)] : []),
      ...buildOptionalSpells(className, level, abilities, pb).filter(action => action.spellLevel === 0),
    ];
    const seenCantrips = new Set<string>();
    actions.push(...cantripPool.filter(action => selectedCantrips.has(action.name) && !seenCantrips.has(action.name) && (seenCantrips.add(action.name), true)));
  }
